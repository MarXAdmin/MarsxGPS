...
const BottomMenu = ({ devicesOpen }) => {
  ...
  return (
    <Paper square elevation={3} sx={{
      ...
      <BottomNavigation value={currentSelection()} onChange={handleSelection} showLabels sx={{ background: '#1F2937', borderRadius: devicesOpen ? '0 0 14px 14px' : '14px', }}>
